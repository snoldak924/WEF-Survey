<?PHP
    class Database
    {
        ...
        public $emailTo = 'sam@oldaks.com'; // Where to send an error report
        public $emailSubject = 'Error on WEF Survey';
        ...
        private function notify()
        {
            ...
            if($this->emailOnError === true)
            {
               ...
               $msg .= "Url: " . full_url() . "\n";
				...
				//mysql_query("INSERT INTO log (user_id,log_text) VALUES ({$Auth->id},".$this->quote($msg).")",$this->writeDB);
				$this->query("INSERT INTO log (user_id,log_text) VALUES ({$Auth->user->id},".$this->quote($msg).")");
				//echo "INSERT INTO log (user_id,log_text) VALUES ({$Auth->id},".$this->quote($msg).")".$this->writeDB;
            }
